...
import { Eye, X, Settings, ShoppingBag, LogIn, UserPlus, ClipboardList } from "lucide-react";
...
export const DevNavigation = forwardRef<HTMLDivElement, DevNavigationProps>(
  ({ currentView, onViewChange }, ref) => {
    const [isOpen, setIsOpen] = useState(false);

    return (
      <div ref={ref} className="fixed bottom-4 right-4 z-[9999]" dir="ltr">
        <AnimatePresence>
          {isOpen && (
            <motion.div
...
DevNavigation.displayName = "DevNavigation";
